...
class MySQLFactoryTest extends SchnoopTestCase
{
    ...
    public function testCreateColumn()
    {
        ...
        /** @var \MilesAsylum\Schnoop\Schema\MySQLFactory|PHPUnit_Framework_MockObject_MockObject $mysqlFactory */
        ...
        $this->assertInstanceOf('MilesAsylum\Schnoop\Schema\MySQL\Column\ColumnInterface', $column);
    ...
    public function testCreateIndexedColumn($column, $hasLength, $length)
    {
        ...
        $this->assertInstanceOf('\MilesAsylum\Schnoop\Schema\MySQL\Index\IndexedColumn', $indexedColumn);
